	...
	<script>
		$(document).ready(function() {
			$('#booking').submit(function(event) {
				...
				var isError = false;
				if (!ValidateControl($('#originBus'))) {
					showToastr("Select Origin!", "error");
					isError = true;
				} else if (!ValidateControl($('#destinationBus'))) {
					showToastr("Select Destination!", "error");
					isError = true;
				} else if (!ValidateControl($('#datetime4'))) {
					showToastr("Select Pickup Date!", "error");
					isError = true;
				} else if (!ValidateControl($('#datetime7'))) {
					showToastr("Select Pickup Time!", "error");
					isError = true;
				} else if (!ValidateControl($('#carType'))) {
					showToastr("Type of car!", "error");
					isError = true;
				}
				if (!isError) {
						...
						<form action="booking.php" method="POST" id="booking">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="originBus" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin City" name="originCity">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="destinationBus" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination City" name="destinationCity">
										<option value="New Delhi" data-tokens="DEL New Delhi">New Delhi</option>
										<option value="Mumbai" data-tokens="BOM Mumbai">Mumbai</option>
										<option value="Kolkata" data-tokens="CCU Kolkata">Kolkata</option>
										<option value="Bangalore" data-tokens="BLR Bangalore">Bangalore</option>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker4">
										<input id="datetime4" type="text" class="inputDate form-control" placeholder="Select Date" name="date" />
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker7">
										<input id="datetime7" type="text" class="inputDate form-control" placeholder="Select Time" name="time" />
										<span class="input-group-addon">
											<span class="fa fa-calendar"></span>
										</span>
									</div>
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<select id="carType" class="selectpicker form-control" data-size="5" title="Select car type" name="carType">
