			...
			<div class="col-sm-12">
				...
				<div class="search" id="searchHotel">
					...
					<div class="content">
						...
						<form action="hotelSearch.php" id="hotelSearch" method="GET">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker6">
										<input id="datetime6" type="text" class="inputDate form-control" placeholder="Select Check-out Date" name="checkOut" />
										<span class="input-group-addon">
											<span class="fa fa-calendar"></span>
										</span>
									</div>
							...
							<div class="col-sm-3">
								...
								<div class="form-group">
									<select id="rooms" class="selectpicker form-control" data-size="5" title="Select no. of rooms" name="rooms">
							...
							<div class="col-sm-3" id="r4">
								...
								<label for="room4">Room 4:<p> </p></label>
								<div class="form-group">
