		...
		<script>
			$(document).ready(function() {
				$('#addtrain').submit(function(event) {
					...
					var isError = false;
					if (!ValidateControl($('#trainNo'))) {
						showToastr("Enter TrainNo!", "error");
						isError = true;
					} else if (!ValidateControl($('#region'))) {
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="manage-trains.php">Home</a><i class="fa fa-angle-right"></i>Create Train</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
					...
					<div class="grid-form1">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="addtrain" method="post" enctype="multipart/form-data" id="addtrain">
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">TrainNo</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="trainNo" id="trainNo" placeholder="TrainNo">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Region</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="region" placeholder="Region" id="region">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Return TrainNo</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="returnTrainNo" id="returnTrainNo" placeholder="returnTrainNo">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Train Name</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="trainName" id="trainName" placeholder="Train Name">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="originTime" id="originTime" placeholder="Origin Time">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Destination Time</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="destinationTime" id="destinationTime" placeholder="Destination Time">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Origin Platform</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="originPlatform" id="originPlatform" placeholder="Origin Platform">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Destination Platform</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="destinationPlatform" id="destinationPlatform" placeholder="Destination Platform">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Duration</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="duration" id="duration" placeholder="Duration">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Classes</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="classes" id="classes" placeholder="Classes">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats 1AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="seats1AC" id="seats1AC" placeholder="Seats 1AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats 2AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="seats2AC" id="seats2AC" placeholder="Seats 2AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats 3AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="seats3AC" id="seats3AC" placeholder="Seats 3AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats SL</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="seatsSL" id="seatsSL" placeholder="Seats SL">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats Chair Car</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="seatsChairCar" id="seatsChairCar" placeholder="Seats Chair Car">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seats Chair Car Ac</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="priceChairCarAC" id="priceChairCarAC" placeholder="Seats Chair Car Ac">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price 1AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="price1AC" id="price1AC" placeholder="Price 1AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price 2AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="price2AC" id="price2AC" placeholder="Price 2AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price 3AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="price3AC" id="price3AC" placeholder="Price 3AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price SL</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="priceSL" id="priceSL" placeholder="Price SL">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price Chair Car</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="priceChairCar" id="priceChairCar" placeholder="Price Chair Car">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Price Chair Car AC</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="priceChairCarAC" id="priceChairCarAC" placeholder="Price Chair Car AC">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Runs On</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="runsOn" id="runsOn" placeholder="Runs On">
										</div>
									</div>
									<div class="row">
...
<?php
	if (isset($_POST['submit'])) {
		...
		try {
			$sql = "INSERT INTO trains(trainNo, region, returnTrainNo, trainName, origin, destination, originCode, destinationCode, originTime, destinationTime, originPlatform, destinationPlatform, duration, classes, seats1AC, seats2AC, seats3AC, seatsSL, seatsChairCar, seatsChairCarAC, price1AC, price2AC, price3AC, priceSL, priceChairCar, priceChairCarAC, runsOn) VALUES(:trainNo, :region, :returnTrainNo, :trainName, :origin, :destination, :originCode, :destinationCode, :originTime, :destinationTime, :originPlatform, :destinationPlatform, :duration, :classes, :seats1AC, :seats2AC, :seats3AC, :seatsSL, :seatsChairCar, :seatsChairCarAC, :price1AC, :price2AC, :price3AC, :priceSL, :priceChairCar, :priceChairCarAC, :runsOn)";
			...
			if ($success) {
				...
				echo "<script>$('#succWrap').append('<strong>SUCCESS</strong>:Train Created Successfully');$('#succWrap').show();</script>";
			} else {
