<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Bus</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="create-bus.php">Create</a></li>
					<li id="menu-academico-avaliacoes"><a href="manage-buses.php">Manage</a></li>
				</ul>
			</li>
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Flight</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="create-flight.php">Create</a></li>
					<li id="menu-academico-avaliacoes"><a href="manage-flights.php">Manage</a></li>
				</ul>
			</li>
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Hotel</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
