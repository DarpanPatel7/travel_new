	...
	<body>
		...
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="manage-buses.php">Home</a><i class="fa fa-angle-right"></i>Manage Buses</li>
				</ol>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td><?php echo htmlentities($result->busID); ?></td>
												...
												<td><?php echo htmlentities($result->arrival); ?></td>
												<td><?php echo htmlentities($result->seats); ?></td>
												<td><?php echo htmlentities($result->fare); ?></td>
												<td><a href="update-bus.php?pid=<?php echo htmlentities($result->busID); ?>"><button type="button" class="btn btn-primary btn-block">Update/View Details</button></a><br />
													<a href="manage-buses.php?action=delete&&id=<?php echo $result->busID; ?>" onclick="return confirm('Do you really want to delete?')" class="btn btn-danger btn-block">Delete</a>
												</td>
											</tr>
									<?php $cnt = $cnt + 1;
										}
