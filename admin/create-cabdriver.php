	...
	<head>
		...
		<script>
			$(document).ready(function() {
				$('#addcabdriver').submit(function(event) {
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="manage-cabdrivers.php">Home</a><i class="fa fa-angle-right"></i>Create Cab Driver</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
					...
					<div class="grid-form1">
						<h3>Create Cab Driver</h3>
						<?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
						<div class="succWrap" id="succWrap" style="display: none;"></div>
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="addcabdriver" method="post" enctype="multipart/form-data" id="addcabdriver">
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Car Type</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="carType" placeholder="Car Type" id="carType">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Car Model</label>
										<div class="col-sm-8">
											<input type="test" class="form-control1" name="carModel" id="carModel" placeholder="Car Model">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">carNo</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="carNo" id="carNo" placeholder="Car No">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">driverName</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="driverName" id="driverName" placeholder="Driver Name">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">driverPhone</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="driverPhone" id="driverPhone" placeholder="Driver Phone">
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">driverRating</label>
										<div class="col-sm-8">
											<input type="number" class="form-control1" name="driverRating" id="driverRating" placeholder="Driver Rating">
										</div>
									</div>
									<div class="row">
...
<?php
	if (isset($_POST['submit'])) {
		...
		try {
			$sql = "INSERT INTO cabdrivers(carType, carModel, carNo, driverName, driverPhone, driverRating) VALUES(:carType, :carModel, :carNo, :driverName, :driverPhone, :driverRating)";
			...
			if ($success) {
				$msg = "Cab Driver Created Successfully";
				echo "<script>showToastr('$msg', 'success');</script>"; // Assuming showToastr is a JavaScript function to show a notification
				echo "<script>$('#succWrap').append('<strong>SUCCESS</strong>:Cab Driver Created Successfully');$('#succWrap').show();</script>";
			} else {
