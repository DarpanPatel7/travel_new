					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php $sql = "SELECT tblissues.id as id,users.FullName as fname,users.Phone as mnumber,users.EMail as email,tblissues.Issue as issue,tblissues.Description as Description,tblissues.PostingDate as PostingDate from tblissues inner join users on users.EMail=tblissues.UserEmail;";
									$query = $dbh->prepare($sql);
									$query->execute();
