		...
		$(document).ready(function() {
			$('#flightSearch').submit(function(event) {
				...
				if (!ValidateControl($('#origin'))) {
					...
					isError = true;
				} else if (!ValidateControl($('#datetime1'))) {
					showToastr("Select Departure Date!", "error");
					isError = true;
				} else if (!ValidateControl($('#datetime2'))) {
					showToastr("Select Return Date!", "error");
					isError = true;
	...
	<div class="container-fluid" id="book">
			...
			<div class="col-sm-12">
				...
				<div class="search">
					...
					<div class="content">
						...
						<form name="flightSearch" action="returnTripOutboundFlightSearch.php" method="POST" id="flightSearch">
		...
		<div class="popularFlights col-sm-12">
			...
			<div class="bg">
				...
				while ($row = $popularFlightsQuery->fetch(PDO::FETCH_ASSOC)) {
