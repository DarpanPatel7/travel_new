	...
	<script>
			$(document).ready(function() {
				$('#trainSearch').submit(function(event) {
					...
					var isError = false;
					if (!ValidateControl($('#originTrain'))) {
						showToastr("Select Origin!", "error");
						isError = true;
					} else if (!ValidateControl($('#destinationTrain'))) {
						showToastr("Select Destination!", "error");
						isError = true;
					} else if (!ValidateControl($('#datetime3'))) {
						showToastr("Select Date!", "error");
						isError = true;
					} else if (!ValidateControl($('#class'))) {
						showToastr("Select Class!", "error");
						isError = true;
					} else if (!ValidateControl($('#adults'))) {
						showToastr("Select No. of adults!", "error");
						isError = true;
					} else if (!ValidateControl($('#children'))) {
						showToastr("Select No. of children!", "error");
						isError = true;
					}
					if (!isError) {
			...
			<div class="col-sm-12">
				...
				<div class="search">
					...
					<div class="content">
						...
						<form action="trainSearch.php" method="POST" id="trainSearch">

							<div class="col-sm-6">
								<div class="form-group">
									<label for="originTrain">Origin:<p> </p></label>

									<select id="originTrain" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin Station" name="origin">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="destinationTrain" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination Station" name="destination">
										<option value="New Delhi" data-subtext="DLI" data-tokens="DLI New Delhi">New Delhi</option>
										<option value="Howrah" data-subtext="HWH" data-tokens="HWH Howrah">Howrah</option>
										<option value="New Jalpaiguri" data-subtext="NJP" data-tokens="NJP New Jalpaiguri">New Jalpaiguri</option>
										<option value="Guwahati" data-subtext="GHY" data-tokens="GHY Guwahati">Guwahati</option>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker3">
										<input id="datetime3" type="text" class="inputDate form-control" placeholder="Select Date" name="date" />
							...
							<div class="col-sm-3">
								...
								<div class="form-group">
									<select id="class" class="selectpicker form-control" data-size="5" title="Select Class" name="class">
