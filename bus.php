...
<head>
	...
	<script>
			$(document).ready(function() {
				$('#busSearch').submit(function(event) {
					...
					if (!ValidateControl($('#originBus'))) {
						...
						showToastr("Select No. of passengers!", "error");
						isError = true;
					}
					if (!isError) {
			...
			<div class="col-sm-12">
				...
				<div class="search">
					...
					<div class="content">
						...
						<form action="busSearch.php" method="POST" id="busSearch">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker4">
										<input id="datetime4" type="text" class="inputDate form-control" placeholder="Select Date" name="dateBus" />
