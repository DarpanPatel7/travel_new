...
<html lang="en">
	...
	<head>
		...
		<?php $titleNameT = 'Booking'; include("common/title.php"); ?>
	...
	<body>
		...
		<div class="bookingWrapper">
			...
			<?php
				...
				$row = $outboundFlightQuery->fetch(PDO::FETCH_ASSOC);
			...
			<?php
				...
				$row = $hotelQuery->fetch(PDO::FETCH_ASSOC);
			...
			<?php
				...
				$rowCab = $cabQuery->fetch(PDO::FETCH_ASSOC);
			...
			<?php
				...
				$row = $busFinderQuery->fetch(PDO::FETCH_ASSOC);
				//$outboundFlightFare = $outboundFlightQuery->fetch_array(MYSQLI_NUM);
			...
			<?php
				...
				$row = $trainFinderQuery->fetch(PDO::FETCH_ASSOC);
				//$outboundFlightFare = $outboundFlightQuery->fetch_array(MYSQLI_NUM);
